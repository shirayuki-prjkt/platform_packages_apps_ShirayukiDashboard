...
package com.itzkaguya.yukidashboard.security.applock
...
import com.itzkaguya.yukidashboard.ShirayukiDashboardFragment

@SearchIndexable
class AppLockSettingsFragment : ShirayukiDashboardFragment(),
    MenuItem.OnMenuItemClickListener {

    private var debugEnabled = SystemProperties.get(DEBUG_PROPERTY, null) == LEVEL_DEBUG
    private var handledClick = false

    override protected fun getPreferenceScreenResId() = R.xml.settings_app_lock
    ...
    companion object {
        ...
        @JvmField
        val SEARCH_INDEX_DATA_PROVIDER = BaseSearchIndexProvider(R.xml.settings_app_lock)
    }
}
