package com.itzkaguya.yukidashboard.preference;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String SHIRAYUKISETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, SHIRAYUKISETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, SHIRAYUKISETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(SHIRAYUKISETTINGSNS, "interval");
            if(newInterval != null)
